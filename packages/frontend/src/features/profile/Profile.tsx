    ...
    <Section>
      ...
      {showChangpassword ? (
        <button
          ...
          className="w-full p-4 bg-base-100 rounded-lg border hover:border-2 border-error cursor-pointer transition-all hover:border-[red]  text-error hover:text-[red]"
